...
public class SenActivity extends AppBaseActivity implements RadioGroup.OnCheckedChangeListener {
    public static final String SEN_INDEX_KEY = "sen_index_key";
    ...
    protected RadioButton radioButton9;
    ...
    protected void initData(Bundle savedInstanceState) {
        ...
        if (intent != null) {
            int intExtra = intent.getIntExtra(SettingActivity.SEND_INDEX_KEY, 0);
    ...
    public void finish(View view) {
        ...
        intent.putExtra(SEN_INDEX_KEY, index);
